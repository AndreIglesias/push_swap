...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/07 21:06:27 by ciglesia          #+#    #+#             */
/*   Updated: 2020/08/09 18:54:11 by ciglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		is_cmd(t_pile **p1, t_pile **p2, char *cm, int ret)
{
	...
	else if (three_cmp(cm, "rra", "rrb", "rrr"))
	{
		...
		ret += ((ft_strcmp(cm, "pb") == 0) ? pab(p1, p2, "") : pab(p2, p1, ""));
	return (ret);
}
...
int		read_cmds(t_pile *p1, t_pile *p2)
{
	...
	pitcher = NULL;
	while (get_next_line2(0, &line, &pitcher) == 1)
	{
